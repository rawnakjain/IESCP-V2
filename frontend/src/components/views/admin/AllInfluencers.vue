            ...
            <div class="table-container table-responsive">
              <table>
                ...
                <tr v-for="influencer in influencers" :key="influencer.id">
                  ...
                  <td v-if="influencer.is_verified">
                    Verified
                  </td>
                  <td v-else>
                    <button class="btn-verify" @click="verifyInfluencer(influencer.id)"><span>Verify</span></button>
                  </td>
                </tr>
                </tbody>
              </table>
...
export default {
  ...
  methods:{
    verifyInfluencer(id){
      this.$store.dispatch("verifyInfluencer", id);
    },
  }
}
</script>
